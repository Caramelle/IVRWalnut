...
def moveAway():
	Tp = 30
	Kt = float(0.023)
	Kp = float(0.22) # Proportional gain. Start value 1 ##0.22 0.15 0.02
	Kd = float(0.15)        # Derivative gain. Start value 0
	Ki = float(0.1) # Integral gain. Start value 0                        # REMEMBER we are using Kd*100 so this is really 
	offset = 40                            # Initialize the variables
	integral = 0.0                          # the place where we will store our integral
	lastError = 0.0                         # the place where we will store the last error value
	derivative = 0.0                        # the place where we will store the derivative
	tangent = 0.0
